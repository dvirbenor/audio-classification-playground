"""Entry point: ``python -m audio_classification_playground.affective_events.review --session ...``.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="affective-events-review",
        description="Launch the affective-events review UI for a saved session.",
    )
